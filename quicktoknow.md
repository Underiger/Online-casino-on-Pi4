...
## 已知缺口（2026-07-03 掃描結果，如實記錄）

- **異常偵測只接了老虎機**：M29 之後的新遊戲（射龍門/高低/21 點/麻將）、
  輪盤、扭蛋、農場都未接 BET_RATE/WIN_RATE/NET_WIN 三規則
- **NET_WIN 每日任務與成就只計老虎機淨勝**，新遊戲輸贏不計入
- **成就子系統無測試覆蓋**（觸發接線散在各路由，早期缺口）
